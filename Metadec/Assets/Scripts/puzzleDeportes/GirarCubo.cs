...
public class GirarCubo : MonoBehaviourPun
{
    int min = 0, seg = 30;
    float restante;
    bool enmarcha;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.tag == "Player")
        {
            ...
            {
                controler.player1Eligio = true;
                controler.tagElegidoP1 = this.tag;
                controler.elementoElegidoP1 = this.gameObject.GetComponent<GirarCubo>();
                this.photonView.RPC("DeportesP1", controler.player2, false, this.tag);
    ...
    [PunRPC]
    public void DeportesP1(bool cond, string eligio, PhotonMessageInfo info)
    {
        controler.player1Eligio = true;
        controler.tagElegidoP1 = eligio;
    }
